<div id="articlebox">
    <div id="leftside">
        <div class="articlebox">
            <div class="cattitle"><i class="fa fa-map-marker"></i> <?= $oCurrentWard->dalong_name ?>,
    ...
    <div id="rightside">
        <div class="articlebox">
            <div class="cattitle"><i class="fa fa-book"></i> Dịch vụ tại <?= $oCurrentWard->dalong_name ?></div>
