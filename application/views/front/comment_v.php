<div id="commentbox">
    <div id="commentform">
        ...
        <? else: ?>
            <span class="smalltext8"><i class="fa fa-exclamation-triangle"></i> Bạn chưa <a
                    href="/login">ĐĂNG
                                  NHẬP</a>, vui lòng nhập các thông tin yêu cầu để bình luận.<br>Những thông tin về email và số điện thoại sẽ được giữ bí mật.<br></span>
